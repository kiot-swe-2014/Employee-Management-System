      ...
      heading.setForeground(Color.RED);
        ...
        add(heading);
         ...
         if (i1.getImageLoadStatus() == MediaTracker.ERRORED) {
           System.err.println("Image not found or failed to load: H:/Employee-Management-System/Employee_Management_System/src/icons/front.jpg");
       ...
       add(image);
        ...
        image.add(clickhere);
          ...
          setSize(1170,650);   // 1170 WIDTH 650 HEIGHT   
          setLocation(200,50); //LEFT 200 TOP 50
          setVisible(true);
